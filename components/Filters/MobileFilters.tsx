...
export const MobileFilters = ({ filters, onChange, categories }: MobileFiltersProps) => {
    ...
    return (
        <div className="w-full flex flex-col mb-4 sticky top-0 z-30 bg-black/80 backdrop-blur-md border-b border-white/5 pb-2 pt-2">
            ...
            {/* 3. Bottom Sheet (Basic Implementation using Fixed Overlay) */}
            <AnimatePresence>
                {isSheetOpen && (
                    <>
                        <motion.div
                        ...
                        <motion.div
                            ...
                            className="fixed bottom-0 left-0 right-0 z-50 bg-[#0d1117] border-t border-zinc-800 rounded-t-2xl max-h-[85vh] flex flex-col shadow-2xl"
                        >
                            {/* Sheet Header */}
