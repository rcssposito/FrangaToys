...
import { Eye, TrendingUp, Trophy, Package, ExternalLink, Image as ImageIcon } from 'lucide-react';
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-zinc-500 font-medium animate-pulse">Calculando popularidade...</p>
            </div>
        );
    }
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-zinc-500 mt-1">As figuras mais desejadas e visualizadas da vitrine.</p>
                </div>
                <button 
