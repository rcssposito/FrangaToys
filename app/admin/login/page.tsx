            ...
            <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 p-8 rounded-2xl shadow-xl">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full bg-white hover:bg-gray-100 text-black font-semibold py-3 rounded-lg transition-all active:scale-95 flex items-center justify-center gap-2"
                    >
                    ...
                    {/* Placeholder for Passkey Login Button */}
                    {/* <button className="...">Entrar com Passkey</button> */}
...
export default function LoginPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center p-4">Carregando...</div>}>
            <LoginContent />
        </Suspense>
    );
}
